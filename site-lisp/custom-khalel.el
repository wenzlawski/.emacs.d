...
;;; Commentary:
;;
;;  This might not be needed anymore since khal config was fixed.
;;
;;; Code:
...
(defcustom khalel-import-org-file-footer "\n* config :noexport:\n\n#+startup: overview\n# Local Variables:\n# eval: (visual-fill-column-mode -1)\n# eval: (buffer-local-set-key (kbd \"e\") 'khalel-edit-calendar-event)\n# End:\n" "Khalel org import file footer."
